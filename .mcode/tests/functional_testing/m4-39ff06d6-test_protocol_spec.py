...
Generated at: 2026-03-16T21:03:40.117677+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "description": "GET /pairs without required org query parameter returns 400",
        "endpoint": "/pairs",
        "method": "GET",
        "request_data": {},
        "expected_status": 400
    ...
    {
        "name": "get_pairs_wrong_method",
        "category": "INVALID_INPUT",
        "description": "POST /pairs returns 405 Method Not Allowed since only GET is supported",
        "endpoint": "/pairs",
        "method": "POST",
        "request_data": {
            "body": {}
