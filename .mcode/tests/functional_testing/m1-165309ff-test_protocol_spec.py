...
Generated at: 2026-03-16T19:24:31.664394+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/org",
        "method": "POST",
        "description": "Create a new organization with valid name and admin",
        "request_data": {
            "path": {},
            "query": {
    ...
    },
    {
        ...
        "endpoint": "/org",
        "method": "POST",
        "description": "Attempt to create organization without the required admin query parameter",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/org",
        "method": "POST",
        "description": "Attempt to create organization with an empty org name string",
        "request_data": {
            "path": {},
            "query": {
                "admin": "testadmin@example.com"
    ...
    },
    {
        ...
        "endpoint": "/org",
        "method": "POST",
        "description": "Attempt to create organization with no request body",
        "request_data": {
            "path": {},
            "query": {
                "admin": "testadmin@example.com"
    ...
    },
    {
        ...
        "endpoint": "/orgs",
        "method": "GET",
        "description": "Create an org then retrieve organizations for that admin",
        "setup": {
            "endpoint": "/org",
            "method": "POST",
            "query": {
                "admin": "getorgs-admin@example.com"
            },
            "body": {
                "org": "test-org-getorgs"
            }
        },
        "request_data": {
            "path": {},
    ...
    },
    {
        ...
        "endpoint": "/orgs",
        "method": "GET",
        "description": "Attempt to get organizations without the required admin query parameter",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_orgs_nonexistent_admin",
        "category": "HAPPY_PATH",
        "endpoint": "/orgs",
        "method": "GET",
        "description": "Get organizations for an admin with no orgs returns empty list",
        "request_data": {
            "path": {},
            "query": {
                "admin": "nonexistent-admin-99@example.com"
            },
            "body": null
        },
        "expected_status": 200,
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create an org then set its cross-match trait",
        "setup": {
            "endpoint": "/org",
            "method": "POST",
            "query": {
                "admin": "cmt-admin@example.com"
            },
            "body": {
                "org": "test-org-cmt"
            }
    ...
    {
        "name": "set_crossmatchtrait_malformed_body",
        "category": "INVALID_INPUT",
        "endpoint": "/crossmatchtrait",
        "method": "POST",
        "description": "Attempt to set cross-match trait with malformed request body",
        "request_data": {
            "path": {},
            "query": {
                "org": "some-org"
