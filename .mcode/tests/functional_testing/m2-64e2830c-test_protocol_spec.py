...
Generated at: 2026-03-16T19:34:20.992117+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "create_members_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/members",
        "method": "POST",
        "description": "Create an organization, then upload a CSV file with members and verify 201 response with member list and traits",
        "setup": {
            "endpoint": "/org",
            "method": "POST",
            "query": {
        ...
        "request_data": {
            ...
            "multipart": {
                ...
                "content": "Name,Email,College,Year\nAlice Smith,alice@example.com,Engineering,2020\nBob Jones,bob@example.com,Science,2021\nCarol White,carol@example.com,Engineering,2022\n",
    ...
    {
        "name": "create_members_missing_org_param",
    ...
    {
        "name": "create_members_invalid_csv_no_name_column",
    ...
    {
        "name": "create_members_no_file_uploaded",
        "category": "MISSING_REQUIRED",
        "endpoint": "/members",
        "method": "POST",
        "description": "Send POST /members with org param but no file attachment, expect 400",
        "setup": {
            "endpoint": "/org",
            "method": "POST",
            "query": {
                "admin": "testadmin3@example.com"
            },
            "body": {
                "org": "test-nofile-org"
            },
    ...
    },
    {
        ...
        "endpoint": "/members",
        "method": "GET",
        "description": "Create an org, upload members via CSV, then retrieve them with GET /members and verify response structure",
        "setup": {
            "endpoint": "/org",
            "method": "POST",
            "query": {
                "admin": "getadmin@example.com"
            },
            "body": {
                "org": "test-get-members-org"
            },
            "extract_id_from": null
        },
        "request_data": {
            ...
            "depends_on_setup": {
                ...
                "multipart": {
                    "field_name": "members",
                    "filename": "members.csv",
                    "content": "Name,Email,Department\nDave Brown,dave@example.com,Sales\nEve Green,eve@example.com,Marketing\n",
                    "content_type": "text/csv"
                }
            }
        },
    ...
    },
    {
        ...
        "endpoint": "/members",
        "method": "GET",
        "description": "Create an org with no members, then GET /members returns empty members list and empty traits",
        "setup": {
            "endpoint": "/org",
            "method": "POST",
            "query": {
                "admin": "emptyadmin@example.com"
            },
            "body": {
                "org": "test-empty-members-org"
            },
            "extract_id_from": null
        },
        "request_data": {
